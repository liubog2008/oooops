...
import (
	...
	mario "github.com/liubog2008/oooops/pkg/client/informers/mario"
...
type SharedInformerFactory interface {
	...
	Mario() mario.Interface
}

func (f *sharedInformerFactory) Mario() mario.Interface {
	return mario.New(f, f.namespace, f.tweakListOptions)
}
