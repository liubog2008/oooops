...
import (
	...
	flowv1alpha1 "github.com/liubog2008/oooops/pkg/apis/flow/v1alpha1"
	...
	v1alpha1 "github.com/liubog2008/oooops/pkg/client/listers/flow/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FlowV1alpha1().Flows(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FlowV1alpha1().Flows(namespace).Watch(options)
			},
		},
		&flowv1alpha1.Flow{},
		resyncPeriod,
...
func (f *flowInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&flowv1alpha1.Flow{}, f.defaultInformer)
}
