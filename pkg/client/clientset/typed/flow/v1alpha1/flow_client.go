...
// FlowV1alpha1Client is used to interact with features provided by the flow.oooops.com group.
type FlowV1alpha1Client struct {
	restClient rest.Interface
}

func (c *FlowV1alpha1Client) Flows(namespace string) FlowInterface {
